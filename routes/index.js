...
router.get("/signup", function (req, res) {
  res.render("index/signup", { username: "signUp" });
});
...
router.get("/verification", function (req, res) {
  ...
  res.render("index/verification", { title: "signUp" });
});

router.post("/verification_complete", function (req, res) {
  res.render("index/verification_complete", { title: "signUp" });
});
...
router.get("/nonsignup", function (req, res) {
  res.render("index/nonsignup", { title: "signUp" });
});

router.get("/movieshow", function (req, res) {
  res.render("index/movieshow", { title: "signUp" });
});
