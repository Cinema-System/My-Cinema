...
FROM PAYLIST_INFO, USER, PAYING, BOOKING, BOOKSEAT_INFO, SEAT, SCHEDULE, MOVIE, THEATER, SCREENWAY, CINEMA, LOCAL
WHERE PAYLIST_INFO.USERID = USER.USERID AND
...
FROM PAYLIST_INFO, USER, PAYING, PAYWAY, POINT
WHERE PAYLIST_INFO.USERID = USER.USERID AND 
    PAYLIST_INFO.PAYNO = PAYING.PAYNO AND
    PAYING.PAYWAYNO = PAYWAY.PAYWAYNO AND 
    PAYING.POINTNO = POINT.POINTNO;
