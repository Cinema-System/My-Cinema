...
CREATE TABLE THEATER (
    ...
    CINEMANO CHAR(7) REFERENCES CINEMA(CINEMANO) NOT NULL,      -- 영화관_식별문자
...
CREATE TABLE SEAT (
    ...
    SCHNO CHAR(10) REFERENCES SCHEDULE(SCHNO),                  -- 상영일정_식별문자
    PRIMARY KEY(SEATNO),
    CONSTRAINT SEATNO_THEATERNO_KEY UNIQUE(SEATNO, THEATERNO)
